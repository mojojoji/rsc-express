...
export async function respondRsc(incoming: http.IncomingMessage, outgoing: http.OutgoingMessage, component: ReactNode) {
	const webpackStream = renderToReadableStream(component);
